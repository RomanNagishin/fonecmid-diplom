...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	//Проверяем договор на период действия и на вид договора.
	...
	//Проверяем заполнение условий оплаты сотруднику
	Запрос = Новый Запрос;
	...
	Если Выборка.Пустой() Тогда
		Отказ = Истина;
		ОбщегоНазначения.СообщитьПользователю("Не заполнены условия оплаты специалисту.");
		Возврат;
	КонецЕсли; 
