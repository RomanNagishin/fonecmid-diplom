...
Процедура ВКМ_ВыполнитьАвтозаполнение(Договор) Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ДоговорыКонтрагентов.ВКМ_АбонентскаяПлата КАК АбонПлатаДоговор
	               |ИЗ
	...
	Пока ВыборкаКонстант.Следующий() Цикл
		...
		АбонПлатаДоговор = ВыборкаКонстант.АбонПлатаДоговор;
	КонецЦикла; 
	...
	ТабЧастьУслуги.Цена = АбонПлатаДоговор;
	ТабЧастьУслуги.Сумма = АбонПлатаДоговор;
