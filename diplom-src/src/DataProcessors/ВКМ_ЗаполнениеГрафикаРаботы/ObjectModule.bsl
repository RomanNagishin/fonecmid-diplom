...
// Заполняет график работы за указанный период в часах, выходные дни 0 часов, рабочие дни 8 часов
//
// Параметры:
// ДатаНачала - Дата - Содержит дату начала периода графика
// ДатаОкончания - Дата - Сожержит дату окончания периода графика
// ВыходныеДни - Число - Содержат числа через запятую равные дню недели выходного дня. 
// Например, 6, 7. Суббота и Воскресенье.
// ГрафикРаботы - СправочникСсылка.ВКМ_ГрафикиРаботы
